...
namespace WinFormsApp1
{
    public partial class OgrenciMesaj : Form
    {
        ...
        private void OgrenciMesaj_Load(object sender, EventArgs e)
        {
            ...
            adp.SelectCommand.Parameters.AddWithValue("@d1", PaylasilanDegerler.Username.ToString());
            ...
            adp1.SelectCommand.Parameters.AddWithValue("@d2", PaylasilanDegerler.Username.ToString());
            ...
            sTUDENTDB.openConnection();
            NpgsqlCommand command = new NpgsqlCommand("select * from ogretmen", sTUDENTDB.getConnection);
            NpgsqlDataReader npgsqlDataReader = command.ExecuteReader();
            while (npgsqlDataReader.Read())
            { list.Add(npgsqlDataReader["sicil_no"].ToString()); }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            cmm.Parameters.AddWithValue("@s1",PaylasilanDegerler.Username.ToString());
